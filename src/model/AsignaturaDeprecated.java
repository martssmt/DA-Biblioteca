...
@Deprecated
public class AsignaturaDeprecated implements Comparable<AsignaturaDeprecated> {
    ...
    public AsignaturaDeprecated(String nombre) {
        this.nombre = nombre;
    ...
    @Override
    public int compareTo(AsignaturaDeprecated otraAsignatura) {
